...
def hello_gcs(cloud_event):
    ...
    load_loyalty_data_to_BQ(bucket,name)

def load_loyalty_data_to_BQ (bucket_name,filename) :
    ...
    pattern =rf'^Loyalty_Program_Data_{current_year}'
    if (re.match(pattern,filename)):
        ...
        try :
            table =bq_client_obj.get_table('customer-marketing-analytics.customer_and_marketing_data.Loyalty_Program')
