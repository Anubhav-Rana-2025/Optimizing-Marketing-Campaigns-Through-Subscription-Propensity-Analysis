...
def hello_gcs(cloud_event):
    ...
    load_crm_data_to_BQ(bucket,name)

def load_crm_data_to_BQ (bucket_name,filename) :
    ...
    pattern =rf'^Customer_Relationship_Management_System_Data_Batch_Upload_{current_year}'
    if (re.match(pattern,filename)):
        ...
        try :
            table =bq_client_obj.get_table('customer-marketing-analytics.customer_and_marketing_data.customer_relationship_management_data')
